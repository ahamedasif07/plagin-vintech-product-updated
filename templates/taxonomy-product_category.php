                ...
                <div class="ventech-product-image">
                    ...
                    <?php else : ?>
                        <div class="ventech-no-image">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120" fill="none" stroke="#d0d5dd" stroke-width="2"><rect x="10" y="10" width="100" height="100" rx="6"/><circle cx="42" cy="42" r="14"/><path d="M10 88 L36 64 L56 80 L78 55 L110 88"/></svg>
                        </div>
                    <?php endif; ?>
                </div>
